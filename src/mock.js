// Mock data for Akshay Deshpande's Portfolio
...
export const projects = [
  ...
  },
  {
    ...
    description: "Enterprise-grade SaaS application with Angular frontend and Node.js backend",
    tech: ["Angular", "Node.js", "MongoDB", "Docker"],
    github: "https://github.com/akshaydeshpande/saas-platform",
    image: "/project3.jpg"
  },
  {
    id: 4,
    title: "AI Audiobook Generator",
    description: "Transform text documents into natural-sounding audiobooks using AI voice synthesis",
    tech: ["OpenAI", "Azure", ".NET", "React"],
    github: "https://github.com/akshaydeshpande/audiobook-ai",
    image: "/project4.jpg"
  }
];

export const skills = {
  "AI & Machine Learning": ["OpenAI GPT", "Azure Cognitive Services", "ML Pipelines"],
  "Cloud Architecture": ["Azure Cloud", "Serverless", "Microservices"],
  "Frontend Development": ["React", "Angular", "TypeScript", "Modern CSS"],
  "Backend Development": ["Node.js", ".NET Core", "REST APIs", "GraphQL"],
  "Database & DevOps": ["MongoDB", "SQL", "Docker", "CI/CD"]
};

// Extended portfolio context for AI chatbot
...
TECHNICAL EXPERTISE:
- AI/ML: OpenAI GPT integration, Azure Cognitive Services, ML pipeline development
- Cloud: Azure Cloud, serverless architectures, microservices design
...
2. Speech-to-Text Pipeline: Developed a real-time speech transcription pipeline with high accuracy using Azure Speech Services
3. Full Stack SaaS Platform: Created an enterprise-grade SaaS application with Angular frontend and Node.js backend
